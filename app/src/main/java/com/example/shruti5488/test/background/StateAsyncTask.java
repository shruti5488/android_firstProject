...
public class StateAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
          //  Log.d("Hello", "Start try");
            ...
            item_id = params[1];
            if(item_id.equalsIgnoreCase("leg_state")) {
...
//                        JSONObject jObject = jArray.getJSONObject(jArray.getJ);
                ...
                for (int j = 0; j < jsonArray.length(); j++) {
                    ...
                    Log.d("Hello", "image" + image);
                    // Log.d("Hello", "name recv" + name);
                    DataService.getInstance().setStateList(image, name, stateName, district);
                }
            }
//                }
